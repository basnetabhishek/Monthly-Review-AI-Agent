...
export default function Page() {
  ...
  return <>
    ...
    {!report && !loading && <div className="emptyState"><span>MONTHLY BUSINESS REVIEW AGENT</span><h2>From governed data to executive clarity.</h2><p>Select any month from August 2022 through July 2026. The agent runs controlled SQL, validates the KPI payload, and produces a traceable executive report.</p><button className="textButton" onClick={generate} disabled={!selectedMonth}>Generate the first report →</button><div className="processRail"><i>01<small>QUERY</small></i><b /><i>02<small>VALIDATE</small></i><b /><i>03<small>EXPLAIN</small></i><b /><i>04<small>ARCHIVE</small></i></div></div>}
