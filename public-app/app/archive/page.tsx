...
export default function ArchivePage() {
  ...
  return <>
    ...
    <div className="privacyNote"><i>LOCAL</i><span><b>Private by design.</b> This archive stays in this browser. It contains only aggregated report output—never your Databricks or OpenAI credentials.</span></div>
